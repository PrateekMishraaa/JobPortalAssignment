...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!agreedToTerms) {
      ...
      Swal.fire("Please agree to the Terms of Service and Privacy Policy!");
      return;
    }
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="px-8 py-8">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white py-3 rounded-lg font-semibold hover:from-purple-700 hover:to-blue-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 transition duration-200 transform hover:scale-[1.02] active:scale-[0.98]"
              >
                Create Account
              </button>
            </form>
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                type="button"
                className="flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition duration-200 focus:outline-none focus:ring-2 focus:ring-purple-500"
              >
          ...
          <div className="px-8 py-6 bg-gray-50 border-t border-gray-200">
            <p className="text-center text-sm text-gray-600">
              ...
              <p
                ...
                className="ml-2 text-purple-600 hover:text-purple-700 font-semibold focus:outline-none"
              >
                Sign In
              </p>
            </p>
